...
* `cosine`, `dot_product`, `max_inner_product`, and `hamming_distance`: Only return vectors where the specified
similarity is at least equal to the provided `similarity`.
--
