...
public final class TwoPhaseRankSearchResult extends SearchPhaseResult {
    ...
    public TwoPhaseRankSearchResult() {}

    public TwoPhaseRankSearchResult(ShardSearchContextId id, SearchShardTarget shardTarget) {
        this.contextId = id;
        setSearchShardTarget(shardTarget);
    }

    public TwoPhaseRankSearchResult(StreamInput in) throws IOException {
        super(in);
    ...
    public TwoPhaseRankSearchResult initCounter() {
        counter = 0;
        return this;
    }
