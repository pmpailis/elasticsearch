...
/**
 * {@code PostQueryShardContext} is a base class used to generate ranking
 ...
 */
public abstract class QueryPhaseShardContext {

    protected final List<Query> queries;
    protected final int windowSize;

    public QueryPhaseShardContext(List<Query> queries, int windowSize) {
