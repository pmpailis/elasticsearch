 ...
 */
public class ShardRankRequest extends TransportRequest implements IndicesRequest {
    ...
    public ShardRankRequest(
        ...
        this.scores = scores.stream().flatMapToDouble(DoubleStream::of).toArray();
    }

    public ShardRankRequest(StreamInput in) throws IOException {
        super(in);
        originalIndices = OriginalIndices.readOriginalIndices(in);
        shardSearchRequest = in.readOptionalWriteable(ShardSearchRequest::new);
        docIds = in.readIntArray();
        scores = in.readDoubleArray();
