    ...
    public record ReducedQueryPhase(
        ...
        public SearchResponseSections buildResponse(
            ...
            return new SearchResponseSections(
                ...
                timedOut,
                terminatedEarly,
                buildSearchProfileResults(fetchResults, profiler == null ? null : profiler.build()),
                numReducePhases
            );
        }
        ...
        private SearchProfileResults buildSearchProfileResults(
            Collection<? extends SearchPhaseResult> fetchResults,
            SearchProfileCoordinatorResults coordinatorResults
        ) {
            ...
            return profileBuilder.build(fetchResults, coordinatorResults);
        }
    }
