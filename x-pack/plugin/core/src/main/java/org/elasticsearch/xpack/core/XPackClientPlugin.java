...
import org.elasticsearch.xpack.core.ml.rerank.TextSimilarityRankDoc;
...
public class XPackClientPlugin extends Plugin implements ActionPlugin, SearchPlugin, NetworkPlugin {
    ...
    public List<NamedWriteableRegistry.Entry> getNamedWriteables() {
        return Stream.of(
            ...
            new NamedWriteableRegistry.Entry(RankDoc.class, XPackField.TEXT_SIMILARITY_RERANKER, TextSimilarityRankDoc::new)
